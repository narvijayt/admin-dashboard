...
Class NeedsAssessmentChoices{
     ...
     * 
     */
    public function _getNeedsAssessmentChoices($data = []){
        $errors = [];     
     ...
     * 
     */
    public function _updateNeedsAssessmentChoice($data = []){
        $errors = [];     
    ...
    public function defaultParameters(){
        return [
            'service'   =>  'api/v1/needs-assessment-choices',
        ];
    }
}