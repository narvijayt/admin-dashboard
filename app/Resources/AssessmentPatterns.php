...
Class AssessmentPatterns{
     ...
     * 
     */
    public function _getAssessmentPatterns($data = []){
        $errors = [];     
    ...
    public function defaultParameters(){
        return [
            'service'   =>  'api/v1/self-assessment-patterns',
            // 'service'   =>  'api/v1/self-assessment-archetype-rules',
        ];
    }
}