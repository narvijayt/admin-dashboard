		...
		<form action="{{ route('dologin') }}" method="post">
            ...
            <div class="form-group mb-3">
				<div class="input-group">
					<span class="input-group-text rounded-0 bg-white"> <i class="fa-solid fa-user"></i></span>
					<input type="text" class="form-control rounded-0" name="user_name" placeholder="Your Username *" value="{{ old('user_name') }}" />
				</div>
            </div>
            <div class="form-group mb-3">
				<div class="input-group ">
					<span class="input-group-text rounded-0 bg-white"> <i class="fa-solid fa-lock"></i></span>
