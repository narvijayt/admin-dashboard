    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 align-items-center py-3">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ 'Assessment Patterns - '.$languages[$lang] }} Translation</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right  mb-0 justify-content-end">
                        ...
                        <li class="breadcrumb-item active">Assessment Patterns Edit </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
                ...
                <div class="col-md-12">
                    <div class="card card-white rounded-0">
                        ...
                        <div class="card-header bg-white py-3">
                            <h5 class="mb-0">{{ 'Assessment Patterns - '.$languages[$lang] }} Translation</h5>
                        </div>
